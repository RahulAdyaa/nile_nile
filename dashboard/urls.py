...
urlpatterns = [
    ...
    path('dashboard/ask/', views.ask_data, name='ask_data'),
    path('dashboard/ask/clear/', views.clear_chat, name='clear_chat'),
    ...
    path('dashboard/cron/', views.cron_jobs, name='cron_jobs'),
